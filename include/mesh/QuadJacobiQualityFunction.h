#ifndef QuadJacobiQualityFunction_h
#define QuadJacobiQualityFunction_h
...
class QuadJacobiQualityFunction: public BaseObjectionFunction<QMesh>
{
public:
...
public:
  QuadJacobiQualityFunction(std::shared_ptr<QMesh> mesh): 
...
#endif // end of QuadJacobiQualityFunction_h
